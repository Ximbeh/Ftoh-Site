    ...
    return (
        <div>
            ...
            <main>
                ...
                <div className="max-w-xl mx-auto md:max-w-3xl md:grid md:grid-cols-2">
                    <div className="px-4">
                ...
                <div className="bg-grayTotal text-white px-4 py-6 mb-10">
                    <div className="max-w-xl mx-auto md:max-w-3xl border-t-8 border-r-8 border-red-500 rounded-tr-3xl relative">
                        <div>
                        ...
                        <div className="pb-4 mb-10 mr-2 border-b-2 border-gray-400 ">
                            <div className="flex">
                                <h3 className="font-formula-bold text-xl">Nome Corrida</h3>
                        ...
                        <div className='flex flex-col gap-2 bg-gray-800 mr-2 rounded-xl px-2 py-4'>
