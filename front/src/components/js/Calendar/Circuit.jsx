        ...
        <div className="px-4 bg-gray-200 pb-10">
            <div className="m-auto max-w-lg md:max-w-5xl lg:max-w-7xl">
                ...
                <div className="mt-10 border-t-8 border-r-8 rounded-tr-3xl py-6 pr-4 relative border-red-500">
                    <img className="absolute -top-4 lg:-top-6 left-0 w-20 lg:w-24 bg-gray-200 px-4" src="https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1000/content/dam/fom-website/2018-redesign-assets/Flags%2016x9/bahrain-flag" alt="" />
