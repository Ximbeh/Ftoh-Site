          ...
          <div>
            <div onClick={() => handleNavigatePilot(driversInfo[0])} className='bg-white shadow-lg relative w-full h-36 rounded-t-2xl flex items-center md:hidden'>
              ...
              <span
                ...
                style={{ backgroundColor: (driversInfo[0]?.teamColor) || 'gray' }}
              ></span>
              <img
                className="w-72 absolute bottom-0 right-2"
                src={driversInfo[0]?.photo
                  ? `../../../../public/img/drivers/${driversInfo[0].photo}`
                  : "../../../../public/img/drivers/default.png"}
                alt="Driver"
              />
            </div>
            <div className='flex gap-4 items-end'>
              <div onClick={() => handleNavigatePilot(driversInfo[1])} className='cursor-pointer relative w-4/12 hidden md:flex flex-col'>
                <div className='bg-white relative h-24 rounded-t-2xl flex'>
                  ...
                  <span className='absolute w-full h-2 bottom-0' style={{ backgroundColor: (driversInfo[1]?.teamColor) || 'gray' }}></span>
                  <img className="w-40 absolute bottom-0 right-2" src={driversInfo[1]?.photo ? `../../../../public/img/drivers/${driversInfo[1].photo}` : "../../../../public/img/drivers/default.png"} alt="Driver" />
                </div>
                <div className='bg-grayTotal h-24 rounded-b-2xl flex text-white flex-col justify-center pl-4'>
                  <div className='flex gap-2 items-center'>
                    {driversInfo[1] && (
                      <h4 className='font-formula'>{driversInfo[1].nome}</h4>
                    )}
                    <img className="w-5 h-min rounded-sm" src={driversInfo[1]?.flag ? `../../../../public/img/race/${driversInfo[1].flag}` : "https://via.placeholder.com/800x400"} alt="Flag" />
                  </div>
                  {driversInfo[1] && (
              ...
              <div onClick={() => handleNavigatePilot(driversInfo[0])} className='cursor-pointer relative w-5/12 hidden md:flex flex-col'>
                <div className='bg-white relative h-32 rounded-t-2xl flex'>
                  ...
                  <span className='absolute w-full h-2 bottom-0' style={{ backgroundColor: (driversInfo[0]?.teamColor) || 'gray' }}></span>
                  <img className="w-56 absolute bottom-0 right-2" src={driversInfo[0]?.photo ? `../../../../public/img/drivers/${driversInfo[0].photo}` : "../../../../public/img/drivers/default.png"} alt="Driver" />
                </div>
                <div className='bg-grayTotal h-24 rounded-b-2xl flex text-white flex-col justify-center pl-4'>
                  <div className='flex gap-2 items-center'>
                    {driversInfo[0] && (
                    ...
                    <img className="w-5 h-min rounded-sm" src={driversInfo[0]?.flag ? `../../../../public/img/race/${driversInfo[0].flag}` : "https://via.placeholder.com/800x400"} alt="Flag" />
                  </div>
                  {driversInfo[0] && (
              ...
              <div onClick={() => handleNavigatePilot(driversInfo[2])}className='cursor-pointer relative w-4/12 hidden md:flex flex-col'>
                <div className='bg-white relative h-24 rounded-t-2xl flex'>
                  ...
                  <span className='absolute w-full h-2 bottom-0' style={{ backgroundColor: (driversInfo[2]?.teamColor) || 'gray' }}></span>
                  <img className="w-48 absolute bottom-0 right-2" src={driversInfo[2]?.photo ? `../../../../public/img/drivers/${driversInfo[2].photo}` : "../../../../public/img/drivers/default.png"} alt="Driver" />
                </div>
                <div className='bg-grayTotal h-24 rounded-b-2xl flex text-white flex-col justify-center pl-4'>
                  <div className='flex gap-2 items-center'>
                    {driversInfo[2] && (
                    ...
                    <img className="w-5 h-min rounded-sm" src={driversInfo[2]?.flag ? `../../../../public/img/race/${driversInfo[2].flag}` : "https://via.placeholder.com/800x400"} alt="Flag" />
                  </div>
                  {driversInfo[2] && (
