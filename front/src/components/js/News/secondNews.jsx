...
const SecondNews = () => {
    ...
    return (
        <div className="hover:cursor-pointer max-w-xs m-auto
        md:max-w-screen-md
        lg: ">
            <div className="py-6 px-3 font-formula">
                ...
                <div className="pt-1 pb-3 px-3 border-r border-b border-l-0 border-t-0 border-solid border-gray-300 hover:border-red-600 rounded-br-3xl min-h-4">
